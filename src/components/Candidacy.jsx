export default function Candidacy() {
  return (
    <section id="candidacy" className="bg-ecos-darker py-16 md:py-24 px-6">
      <div className="max-w-[1200px] mx-auto">
        <div className="mb-10">
          <span className="font-condensed font-semibold mb-4 block" style={{ color: '#4BED07', fontSize: '18px', lineHeight: '26px' }}>За кандидатурата</span>
          <h2
            className="font-condensed font-bold italic uppercase text-4xl md:text-[58px] md:leading-[63.80px]"
            style={{ color: '#4BED07', maxWidth: '1000px' }}
          >
            Успешната кандидатура не се представя на гражданите, а се{' '}
            <span style={{ color: '#FFF' }}>създава заедно</span>
            <span style={{ color: '#4BED07' }}> с тях.</span>
          </h2>
        </div>

        <p className="text-ecos-lime font-sans text-xl md:text-2xl leading-relaxed mb-16 opacity-90" style={{ maxWidth: '1000px' }}>
          Титлата Европейска столица на спорта се присъжда от{' '}
          <a href="https://aceseurope.eu/" target="_blank" rel="noopener noreferrer" className="underline">ACES Europe</a>,
        ...
        <div className="flex flex-col md:flex-row bg-ecos-bright overflow-hidden">
          ...
          <div className="md:w-[63%] p-10 md:p-14 flex flex-col justify-center gap-6">
            <span className="font-condensed font-semibold text-8xl text-ecos-dark leading-none -mb-8">&ldquo;</span>
